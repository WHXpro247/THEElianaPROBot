...
def Eliana_about_callback(update, context):
    ...
    if query.data == "Eliana_":
        query.message.edit_text(
            text=""" ℹ️ I'm *THE Eliana PRO Bot*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_Eliana's licensed under the GNU General Public License v3.0_
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *THE Eliana PRO Bot*
                 \nHere is the [Source Code](https://github.com/THEElianaPRO/THEElianaPROBot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
