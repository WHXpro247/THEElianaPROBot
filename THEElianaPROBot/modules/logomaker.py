...
async def lego(event):
 ...
 try:
    ...
    fname2 = "LogoByEliana.png"
    img.save(fname2, "png")
    await tbot.send_file(event.chat_id, fname2, caption="Made By @THEElianaPRO Support @TEP_Discussion")
    if os.path.exists(fname2):
            os.remove(fname2)
 except Exception as e:
   await event.reply(f'Error Report @TEP_Discussion, {e}')
