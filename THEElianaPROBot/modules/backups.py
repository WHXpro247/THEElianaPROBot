...
import THEElianaPROBot.modules.sql.notes_sql as sql
from THEElianaPROBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from THEElianaPROBot.__main__ import DATA_IMPORT
from THEElianaPROBot.modules.helper_funcs.chat_status import user_admin
from THEElianaPROBot.modules.helper_funcs.alternate import typing_action

# from THEElianaPROBot.modules.rules import get_rules
import THEElianaPROBot.modules.sql.rules_sql as rulessql

# from THEElianaPROBot.modules.sql import warns_sql as warnssql
import THEElianaPROBot.modules.sql.blacklist_sql as blacklistsql
from THEElianaPROBot.modules.sql import disable_sql as disabledsql

# from THEElianaPROBot.modules.sql import cust_filters_sql as filtersql
# import THEElianaPROBot.modules.sql.welcome_sql as welcsql
import THEElianaPROBot.modules.sql.locks_sql as locksql
from THEElianaPROBot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("THEElianaPROBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("THEElianaPROBot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `THEElianaPROBot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("THEElianaPROBot{}.backup".format(chat_id))  # Cleaning file
